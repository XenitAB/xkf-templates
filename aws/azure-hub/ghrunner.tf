module "ghrunner" {
  source            = "github.com/xenitab/terraform-modules//modules/azure/github-runner?ref=2023.04.3"
  ...
  vmss_subnet_config = {
    name                 = module.hub.subnets["sn-${var.environment}-${var.azure_location_short}-${var.hub_name}-servers"].name
