...
module "eks1" {
  source = "github.com/xenitab/terraform-modules//modules/aws/eks?ref=$VERSION"
...
module "eks1_core" {
  source = "github.com/xenitab/terraform-modules//modules/kubernetes/eks-core?ref=$VERSION"
