...
module "eks1" {
  source = "github.com/xenitab/terraform-modules//modules/aws/eks?ref=2022.12.3"
...
module "eks1_core" {
  source = "github.com/xenitab/terraform-modules//modules/kubernetes/eks-core?ref=2022.12.3"
