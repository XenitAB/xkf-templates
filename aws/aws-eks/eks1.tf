...
module "eks1" {
  source = "github.com/xenitab/terraform-modules//modules/aws/eks?ref=2023.01.1"
...
module "eks1_core" {
  source = "github.com/xenitab/terraform-modules//modules/kubernetes/eks-core?ref=2023.01.1"
