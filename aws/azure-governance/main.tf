...
module "governance_global" {
  source = "github.com/xenitab/terraform-modules//modules/azure/governance-global?ref=2022.10.3"
...
module "governance_regional" {
  source = "github.com/xenitab/terraform-modules//modules/azure/governance-regional?ref=2022.10.3"
...
module "xkf_governance_global" {
  source            = "github.com/xenitab/terraform-modules//modules/azure/xkf-governance-global?ref=2022.10.3"
  cloud_provider    = "aws"
  environment       = var.environment
  subscription_name = var.azure_subscription_name
