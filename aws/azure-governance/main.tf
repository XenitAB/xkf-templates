...
module "governance_global" {
  source = "github.com/xenitab/terraform-modules//modules/azure/governance-global?ref=azurerm_update"
...
module "governance_regional" {
  source = "github.com/xenitab/terraform-modules//modules/azure/governance-regional?ref=azurerm_update"
...
module "xkf_governance_global" {
  source            = "github.com/xenitab/terraform-modules//modules/azure/xkf-governance-global?ref=azurerm_update"
  cloud_provider    = "aws"
  environment       = var.environment
  subscription_name = var.azure_subscription_name
