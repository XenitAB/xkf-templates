...
module "governance_global" {
  source = "github.com/xenitab/terraform-modules//modules/azure/governance-global?ref=$VERSION"
...
module "governance_regional" {
  source = "github.com/xenitab/terraform-modules//modules/azure/governance-regional?ref=$VERSION"
...
module "xkf_governance_global" {
  source            = "github.com/xenitab/terraform-modules//modules/azure/xkf-governance-global?ref=$VERSION"
  cloud_provider    = "aws"
  environment       = var.environment
  subscription_name = var.azure_subscription_name
