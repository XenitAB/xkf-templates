...
module "governance_global" {
  source = "github.com/xenitab/terraform-modules//modules/azure/governance-global?ref=2023.06.5"
...
module "governance_regional" {
  source = "github.com/xenitab/terraform-modules//modules/azure/governance-regional?ref=2023.06.5"
...
module "xkf_governance_global" {
  source            = "github.com/xenitab/terraform-modules//modules/azure/xkf-governance-global?ref=2023.06.5"
  cloud_provider    = "aws"
  environment       = var.environment
  subscription_name = var.azure_subscription_name
