...
module "aks1" {
  source = "github.com/xenitab/terraform-modules//modules/azure/aks?ref=test_governance_fix"
...
module "aks1_core" {
  source = "github.com/xenitab/terraform-modules//modules/kubernetes/aks-core?ref=test_governance_fix"
  providers = {
