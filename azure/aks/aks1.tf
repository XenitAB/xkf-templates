...
module "aks1" {
  source = "github.com/xenitab/terraform-modules//modules/azure/aks?ref=$VERSION"
...
module "aks1_core" {
  source = "github.com/xenitab/terraform-modules//modules/kubernetes/aks-core?ref=$VERSION"
  providers = {
