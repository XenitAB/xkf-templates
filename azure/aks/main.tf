...
module "xkf_governance_global_data" {
  source            = "github.com/xenitab/terraform-modules//modules/azure/xkf-governance-global-data?ref=2024.05.1"
...
module "aks_regional" {
  source = "github.com/xenitab/terraform-modules//modules/azure/aks-regional?ref=2024.05.1"
