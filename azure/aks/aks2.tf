...
module "aks2" {
  source = "github.com/xenitab/terraform-modules//modules/azure/aks?ref=2023.06.2"
...
module "aks2_core" {
  source = "github.com/xenitab/terraform-modules//modules/kubernetes/aks-core?ref=2023.06.2"
  providers = {
