...
module "aks2" {
  source = "github.com/xenitab/terraform-modules//modules/azure/aks?ref=azurerm_update"
...
module "aks2_core" {
  source = "github.com/xenitab/terraform-modules//modules/kubernetes/aks-core?ref=azurerm_update"
  providers = {
